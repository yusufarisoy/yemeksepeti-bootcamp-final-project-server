...
class Restaurant {
    ...
    findAll = async params => {
        ...
        FROM ${this.tableName} r JOIN cities c ON r.city_id = c.id JOIN districts d ON r.district_id = d.id LEFT JOIN ratings ra ON ra.restaurant_id = r.id`;
    ...
    findMostPopulars = async cityId => {
        ...
        FROM ${this.tableName} r JOIN cities c ON r.city_id = c.id JOIN districts d ON r.district_id = d.id LEFT JOIN ratings ra ON ra.restaurant_id = r.id WHERE 
